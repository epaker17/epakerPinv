...
var ICONS = {
  add: async () => (await import("./add-URSBU2IS.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-DNJ3KAU2.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-YTRPHLXR.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-ELFMRKNS.js")).appStoreSvg,
  apple: async () => (await import("./apple-NHDO7K7I.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-567FNZLO.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-3VX53UTN.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-XK34AUVA.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-7YGFP7VZ.js")).arrowTopSvg,
  bank: async () => (await import("./bank-EBMDXW52.js")).bankSvg,
  browser: async () => (await import("./browser-ZMNXNQGU.js")).browserSvg,
  card: async () => (await import("./card-FL5XNVPB.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-K3O33TLQ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-H2NE22HX.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-C3AMJ4PW.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-MLTBX3E3.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-764OF3RL.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-RZH7SLFW.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-3GV2C6F5.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-V5SVRO3M.js")).clockSvg,
  close: async () => (await import("./close-GGPHSXAM.js")).closeSvg,
  compass: async () => (await import("./compass-ZANRMIFN.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ULDTARKG.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-PCKCWH7J.js")).copySvg,
  cursor: async () => (await import("./cursor-LXTIEBBT.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-KJAS5RY4.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-GORIMSMX.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-WTFM5CVM.js")).disconnectSvg,
  discord: async () => (await import("./discord-XX6AA7YQ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-2DVIYRBP.js")).etherscanSvg,
  extension: async () => (await import("./extension-FWJDG24H.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-5R5NI5BF.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-UXIQ5KUV.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-LACMUBMC.js")).farcasterSvg,
  filters: async () => (await import("./filters-WAXDJRT6.js")).filtersSvg,
  github: async () => (await import("./github-ZMAPHGNY.js")).githubSvg,
  google: async () => (await import("./google-64D2RGDY.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-4KNKMYAU.js")).helpCircleSvg,
  image: async () => (await import("./image-WJO7DEBS.js")).imageSvg,
  id: async () => (await import("./id-4TM2SBUM.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-OHVMKEIB.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-OZXQSEH4.js")).lightbulbSvg,
  mail: async () => (await import("./mail-KPYVLA7I.js")).mailSvg,
  mobile: async () => (await import("./mobile-7OFUYQ3K.js")).mobileSvg,
  more: async () => (await import("./more-JYUIX6IC.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-C3ATS6CF.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-R2F3TSC6.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-BC4L26PD.js")).offSvg,
  playStore: async () => (await import("./play-store-PAMVDWVT.js")).playStoreSvg,
  plus: async () => (await import("./plus-5EL6UNGE.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-FCDXMNK6.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-2DVNUZYT.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-VPGITLGH.js")).refreshSvg,
  search: async () => (await import("./search-AHTXSTFR.js")).searchSvg,
  send: async () => (await import("./send-HR4SYWDJ.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-FQQGHEC4.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-2SFEMG7B.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-GH4QERBC.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-X6ZOT2QW.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-VJKZVUGO.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-53LG6DMN.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-VKVD6CZW.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-LBPQ6CJE.js")).twitchSvg,
  twitter: async () => (await import("./x-OLHJX5RU.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-ONCVYIXT.js")).twitterIconSvg,
  verify: async () => (await import("./verify-N2644D7Z.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-UNPYHCZ5.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-VXXQNHMH.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-EQ4MKN6E.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-EQ4MKN6E.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-EQ4MKN6E.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-AI6PRGFO.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-DX36IVGU.js")).warningCircleSvg,
  x: async () => (await import("./x-OLHJX5RU.js")).xSvg,
  info: async () => (await import("./info-ASXICPKQ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-RH2M3HXW.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-JY43MXEP.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-T2B3EOFL.js.map
